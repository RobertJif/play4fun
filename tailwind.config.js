...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      'gradient-100-0': 'var(--color-gradient-100-0)',
      'gradient-100-100': 'var(--color-gradient-100-100)',
      'gradient-200-0': 'var(--color-gradient-200-0)',
      'gradient-200-50': 'var(--color-gradient-200-50)',
      'gradient-200-100': 'var(--color-gradient-200-100)',
      'gradient-300-0': 'var(--color-gradient-300-0)',
      'gradient-300-100': 'var(--color-gradient-300-100)',
